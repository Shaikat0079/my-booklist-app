...
import BookListCard from "@/components/shared/BookListCard";
...
const ListedBooks = () => {
  ...
  return (
    <div className="container mx-auto py-10">
      {/* {readBooks.length} */}
      <h2 className="my-5 bg-cyan-300 rounded-3xl py-16 font-bold text-4xl text-center">
        Listed Books
      </h2>
        ...
        <div className="tab-content bg-base-100 border-base-300 p-6">
          {sortedReadBooks.length > 0 ? (
            sortedReadBooks.map((book: IBook) => {
              return <BookListCard key={book.bookId} book={book} />;
            })
          ) : (
